...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    while index > 0u {
        ...
        if (a.x > a.w && b.x > b.w && c.x > c.w && d.x > d.w) || (a.x < -a.w && b.x < -b.w && c.x < -c.w && d.x < -d.w) || (a.y > a.w && b.y > b.w && c.y > c.w && d.y > d.w) || (a.y < -a.w && b.y < -b.w && c.y < -c.w && d.y < -d.w) || (a.z > a.w && b.z > b.w && c.z > c.w && d.z > d.w) || (a.z < -a.w && b.z < -b.w && c.z < -c.w && d.z < -d.w) {
            continue;
        }
        ...
        if z < 1 || area(array(screen(a), screen(b), screen(c), screen(d))) > 0.25 {
